<template>
  <form>
    ...
    <div class="field checkboxField">
      <input type="checkbox" v-model="animal" /><label>Cat</label>
      <input type="checkbox" v-model="animal" /><label>Dog</label>
      <input type="checkbox" v-model="animal" /><label>Dinosaur</label>
    </div>
  </form>
